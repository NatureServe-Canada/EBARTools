...
bba_hbe_fields = {'quality_grade': None,
                  'unique_id': 'GlobalUniqueIdentifier',
                  'uri': None,
                  'license': None,
                  'scientific_name': 'ScientificName',
                  ...
                  'date': None,
                  'basis_of_record': 'BasisOfRecord',
                  'individual_count': 'ObservationCount',
                  'geoprivacy': None,
                  'taxon_geoprivacy': None,
                  'breeding_code': 'BreedingBirdAtlasCode',
                  'original_institution_code': None,
...
bba_other_fields = {'quality_grade': None,
                    'unique_id': 'GlobalUniqueIdentifier',
                    'uri': None,
                    'license': None,
                    'scientific_name': 'ScientificName',
...
tabular_field_mapping_dict = {'GBIF': gbif_fields,
                              ...
                              'iNaturalist.ca (original coordinates for obscured records)': inaturalistca_fields,
                              'BISON': bison_fields,
                              ...
                              # this one has been replaced by ON Breeding Bird Atlas- Highest Breeding Evidence per square
                              ...
                              # with dashes I prefer space before and after, or no spaces
                              # these specs may the same in other provinces down the road
                              'ON Breeding Bird Atlas- Highest Breeding Evidence per square': bba_hbe_fields,
                              'ON Breeding Bird Atlas- Special Surveys': bba_other_fields,
                              'ON Breeding Bird Atlas- Point Count data': bba_other_fields,
                              'ON Breeding Bird Atlas- Checklist data': bba_other_fields,
                              'ON Breeding Bird Atlas- Species at Risk data': bba_other_fields,
                              'Other': other_fields}
